...
merge_delta_data(final_df, "f1_processed","qualifying",processed_folder_path, "tgt.qualify_id=src.qualify_id AND tgt.race_id = src.race_id", "race_id")

# COMMAND ----------

# display(spark.read.parquet('/mnt/formula1fotisdl/processed/qualifying'))
