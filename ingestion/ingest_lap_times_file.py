...
merge_delta_data(final_df, "f1_processed","lap_times",processed_folder_path, "tgt.race_id = src.race_id AND tgt.driver_id=src.driver_id AND tgt.lap = src.lap", "race_id")
