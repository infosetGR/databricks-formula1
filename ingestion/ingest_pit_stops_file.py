...
merge_delta_data(final_df, "f1_processed","pit_stops",processed_folder_path, "tgt.race_id = src.race_id AND tgt.driver_id=src.driver_id AND tgt.stop = src.stop", "race_id")

# COMMAND ----------

# display(spark.read.parquet("/mnt/formula1fotisdl/processed/pit_stops"))
