...
# races_selected_df.write.mode('overwrite').partitionBy('race_year').parquet('/mnt/formula1fotisdl/processed/races')
...
# MAGIC %fs
# MAGIC ls /mnt/formula1fotisdl/processed/races

# COMMAND ----------

# display(spark.read.parquet('/mnt/formula1fotisdl/processed/races'))
