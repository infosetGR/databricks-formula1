...
merge_delta_data(final_df, "f1_presentation","driver_standings",presentation_folder_path, "tgt.driver_name = src.driver_name AND tgt.race_year=src.race_year", "race_year")
