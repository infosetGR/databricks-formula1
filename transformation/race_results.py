...
# .withColumnRenamed("data_source", "result_data_source") \
# .withColumnRenamed("ingestion_date", "result_ingestion_date") \
...
race_results_df = results_df.join(race_circuits_df, results_df.result_race_id == race_circuits_df.race_id) \
                            .join(drivers_df, results_df.result_driver_id == drivers_df.driver_id) \
...
merge_delta_data(final_df, "f1_presentation","race_results",presentation_folder_path, "tgt.driver_name = src.driver_name AND tgt.race_id=src.race_id", "race_id")
